...
terrain['sand'] = terrain['sand']+['2002','2003','2105','1920','2121','2221','2222','2120','2119','2020','2019','1902'] 
terrain['sand'] = terrain['sand']+['','2003','2105','1920','2121','2221','2222','2120','2119','2020','2019','1902','1818','1919'] 
terrain['sand'] = terrain['sand']+hr(21,23,6)+hr(26,27,6)+hr(23,27,23)+hr(23,15,18)+hr(11,13,19)+hr(8,10,20)+hr(14,16,4)+hr(13,16,18)
terrain['desert'] = ['0716','0813','1113','1412','1505','1406','1806','1807','1912','0918','1019','0911','0911','1017','0815']
...
terrain['marsh'] = ['1306','1307','2119','1413']
terrain['marsh'] = terrain['marsh']+hr(12,21,15)+hr(13,17,14)+hr(16,19,13)+hr(19,20,16)+hr(15,15,9)+hr(14,21,8)+hr(20,20,5)+hr(20,21,20)+hr(21,22,21)
terrain['marsh'] = terrain['marsh']+hr(13,15,7)
terrain['water'] = ['2010','2110','2111','2211'] #inlandsea
terrain['bush'] = ['0811','1110','2915','2617','2618','2219','2220','2404','2505','2506','2709','2710','2811','3015','2916','3017','2918','2821','1918']
terrain['bush'] = terrain['bush'] + ['1016','1117','2915','2617','2618','2219','2220','2404','2505','2506','2709','2710','2811','3015','2916','3017','2918','2821']
terrain['bush'] = terrain['bush']+hr(11,12,0)+hr(12,13,8)+hr(10,12,18)+hr(13,18,17)+hr(23,27,22)
